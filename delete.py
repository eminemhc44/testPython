...
dbx = dropbox.Dropbox("S6gzIPxWC2UAAAAAAAB1uOhmxlZFDkvn_KRbek4d-cll0IProDjqd8nMJ6goqYR4")


_, res = dbx.files_download(path="/combined_ep_221.h5")
...
cyclegan = CycleGAN()
cyclegan.load_network(n_epoch_start = 220,path=res.content)
